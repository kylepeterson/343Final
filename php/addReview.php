<?php
	...
	foreach ($apartmentData as $apt) {
		if ($apt -> name == $apartmentName) {
			...
			header('Location: http://students.washington.edu/wsmay1/info343/final/thanks.html'); //redirect users to a page notifying them of their successful review
			die();
		}
	}
	...
	if(!$found) {
		header('Location: http://students.washington.edu/wsmay1/info343/final/notFound.html');
		die();
	}
?>